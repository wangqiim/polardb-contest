...
using primary_key = emhash8::HashMap<int64_t, UserWithoutId>;
using unique_key  = emhash8::HashMap<UserIdWrapper, int64_t>;
using normal_key  = std::multimap<int64_t, int64_t>;
using hack_key  = emhash8::HashMap<int64_t, int64_t>;
